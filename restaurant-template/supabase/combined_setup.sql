...
-- ────────────────────────────────────────────────────────────────
-- SEED: 6 categories + 27 menu items
-- ────────────────────────────────────────────────────────────────
...
insert into public.menu_items
  (id, name, description, price_cents, category_id, dietary_tags, is_available, is_featured)
values
  -- Starters
...
-- ================================================================
-- Done! You should now have all tables + 27 menu items.
-- ================================================================
